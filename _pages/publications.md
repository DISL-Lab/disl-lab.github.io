...
<p style="font-size: 0.8rem; color: #888; margin: -1rem 0 1.5rem 0; font-style: italic;">
  * denotes corresponding authors &nbsp;|&nbsp; {} denotes co-first authorship
</p>
...
<div class="project-block">
  ...
  <div class="text-col">
   ...
   <span style="
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Yuho Lee, Jisu Shin, Hee-Yeon Kim, Jihwan Bang, Juntae Lee, Kyuwoong Hwang, Fatih Porikli, and Hwanjun Song*
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/27-arXiv-socrat.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Taewon Yun, Hyeonseong Park, Jeonghwan Choi, Hayoon Park, Yeeun Choi, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     arXiv preprint arXiv:2606.05563, 2026
    </p>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-cite.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    ">
      ...
      Show Me How You Cite: Citation Fidelity, Usage, and Topology in the Evidence Behavior of AI Scientific Writing
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      {Jihwan Oh, Gyeonghun Sun}, Jisoo Kim, Yuho Lee, Taewon Yun, Jisu Shin, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Empirical Methods in Natural Language Processing (Main), 2026
    </p>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-gearec.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    ">
      ...
      Illuminating the Path: Reachability-Aware Supervision Curation for LLM-Based Recommendation
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Donghee Han, Jiwon Jeong, Hwanjun Song*, and Mun Yong Yi*
    </p>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-taccot.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    ">
      ...
      TAC-CoT: Tool-Empowered Implicit Chain-of-Thought via Interleaving Explicit Tokens
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Juseon Do, Sangmin Bae, Jeesu Jung*, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Empirical Methods in Natural Language Processing (Main), 2026
    </p>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-scroll.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Hyangsuk Min and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Empirical Methods in Natural Language Processing (Findings), 2026
    </p>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-robustrag.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    ">
      ...
      Towards Robust Retrieval-Augmented Generation via Reliability-Aware Adaptive Evidence Selection
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Minkyu Che, Jihwan Oh, Jeonghwan Choi, Jeesu Jung*, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Empirical Methods in Natural Language Processing (Findings), 2026
    </p>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-emnlp-timelyrag.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Youngeun Nam, Joeun Kim, Hwanjun Song, Susik Yoon, Jae-Gil Lee*, and Byung Suk Lee
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Empirical Methods in Natural Language Processing (Findings), 2026
    </p>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-cikm-tagrec.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
        display: inline-block;
        background-color:rgb(0, 109, 119);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
    ...
    ">
      ...
      TAG-Rec: Grounding LLM-based Recommendation via Trigger-Anchored GRPO
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Donghee Han, Jiwon Jeong, Hwanjun Song*, and Mun Yong Yi*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In International Conference on Information and Knowledge Management, 2026
    </p>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/26-cikm-nologs.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    ">
      ...
      No Logs, Only Catalogs: Catalog-to-Supervision Training for Recommendation with LLM-Simulated Preferences
    </h3>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Donghee Han, Jiwon Jeong, Hwanjun Song*, and Mun Yong Yi*
    </p>
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Jihwan Oh, Taewon Yun, Minkyu Che, Sundong Kim, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In Conference on Language Modeling, 2026
    </p>
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Gyeonghun Sun, Jeonghwan Choi, Sundong Kim, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In Conference on Language Modeling, 2026
    </p>
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Jeonghwan Choi, Taewon Yun, Minjeong Ban, Jae-Gil Lee, and Hwanjun Song*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     In Conference on Language Modeling, 2026
    </p>
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Youngjun Lee, Doyoung Kim, Junhyeok Kang, Hwanjun Song, and Jae-Gil Lee*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; font-family: 'Roboto', monospace; color: #111;">
      Doyoung Kim, Youngjun Lee, Joeun Kim, Jihwan Bang, Hwanjun Song, Susik Yoon, and Jae-Gil Lee*
    </p>
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
...
<div class="project-block">
  ...
  <div class="text-col">
    ...
    [<a href="https://huggingface.co/DISLab/Ext2Gen-8B-R2" style="text-decoration: none; color: #1a73e8;">Model</a>] 
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-dmkd-han.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
        display: inline-block;
        background-color:rgb(47, 91, 211);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-sigir-bang.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <span style="
        display: inline-block;
        background-color:rgb(130, 60, 14);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-acl-min.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-w2p-choi.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-kdd-nam.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-icwsm-na.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
        display: inline-block;
        background-color:rgb(27, 42, 109);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
      In International AAAI Conference on Web and Social Media, 2025
    </p>
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
    </div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-naacl-song.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    [<a href="https://huggingface.co/DISLab/SummLlama3-8B" style="text-decoration: none; color: #1a73e8;">Data</a>] 
    [<a href="https://huggingface.co/datasets/DISLab/FeedSum" style="text-decoration: none; color: #1a73e8;">Model</a>] 
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-naacl-manaz.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-iclr-lee.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/25-coling-oh.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="https://arxiv.org/pdf/2412.10689" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-emnlp-lee.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    [<a href="https://github.com/disl-lab/unisumeval-v1.0" style="text-decoration: none; color: #1a73e8;">Data</a>] 
    </div>
    </div>
  </div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-neurips-shin.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-eccv-ma.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-pr-prompt.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-iot-qhyvit.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
        display: inline-block;
        background-color:rgb(8, 103, 138);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-acl-finesure.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-acl-negate.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-icml-onesize.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-naacl-magid.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-naacl-tofu.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-naacl-ssds.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-www-time.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-aaai-cl.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/24-aaai-balancemix.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-emnlp-discal.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    [<a href="https://github.com/amazon-science/discal" style="text-decoration: none; color: #1a73e8;">Code</a>] 
    </div>
    </div>
  </div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-emnlp-free.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-neurips-robust.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-iccv-dap.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-icml-corssmatch.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-cvpr-logo.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-iclr-online.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/23-vldb-survey.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <span style="
        display: inline-block;
        background-color:rgb(12, 88, 41);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
      The VLDB Journal (SCIE, IF=4.2), 2023
    </p>
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
     <span style="color:rgb(255, 11, 11); font-weight: bold;">Over 500 citations</span>
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-neurips-mqnet.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-neurips-ssl.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-icdm-pincet.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-cikm-eclip.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-cikm-fedrn.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-cikm-refine.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-tnnls-noisy.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <p style="font-size: 0.9rem; margin-bottom: 0.2rem; color:rgb(2, 4, 6); font-style: italic">
     IEEE Transactions on Neural Networks and Learning Systems (SCIE, IF=14.255), 2022
    </p>
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
    <span style="color:rgb(255, 11, 11); font-weight: bold;">Over 1,000 citations</span>
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-icml-time.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-icml-condense.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
     <span style="color:rgb(255, 11, 11); font-weight: bold;">Over 200 citations</span>
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-iclr-time.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-iclr-vidt.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
  ...
  In International Conference on Learning Representations, 2022
    ...
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
    <span style="color:rgb(255, 11, 11); font-weight: bold;">Over 100 citations</span>
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-aaai-melon.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-aaai-covidee.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/22-cvpr-puridiver.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/21-neurips-taufe.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/21-bmvc-medusa.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/21-kdd-morph.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/21-kdd-tutorial.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <span style="
        display: inline-block;
        background-color:rgb(14, 74, 57);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
    ...
    <div style="font-size: 0.8rem; color: #555; margin-top: 0.0rem;">
    [<a href="#" style="text-decoration: none; color: #1a73e8;">PDF</a>] 
    [<a href="#" style="text-decoration: none; color: #1a73e8;">Video</a>] 
    </div>
  </div>
</div>
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/21-aaai-premere.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/20-cikm-carpe.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/20-ml-adabound.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/20-kdd-hicovid.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/20-pakdd-survival.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/20-www-trap.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/19-icml-selfie.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/18-sigmod-rpdbscan.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
    ...
    <span style="
        display: inline-block;
        background-color:rgb(6, 68, 78);  /* 원하는 색으로 변경 가능 */
        color: white;
        font-weight: bold;
        font-size: 0.75rem;
        padding: 0.2rem 0.6rem;
...
<div class="project-block">
  <div class="img-col">
    <img src="/assets/img/paper/17-kdd-pamae.png" alt="Project 1">
  </div>
  <div class="text-col">
    <h3 style="font-size: 0.9rem; margin-bottom: 0.2rem; font-weight: bold;">
    <span style="
